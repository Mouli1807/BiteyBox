const About = () => {
    return(
        <div className="font-['Poppins',_sans-serif] w-[75vw] h-[150vh] my-[10px] mx-auto p-[5px] bg-white rounded-[12px] shadow-[0px_4px_10px_rgba(0,0,0,0.1)] text-center">
             ...
             <div className="text-[1.5rem]">Bite-Box is more than just a food and meal-planning app—it's my personal journey into mastering React and JavaScript. 
             ...
             <h2 className="mt-[40px] text-[2rem] text-[#492e6b]">Why I Built Bite-Box</h2>
             <div className="text-[1.5rem]">I created Bite-Box as a learning experience to dive deep into modern web development. Through this project, I'm not just building an app; I'm understanding how React works at its core, 
             ...
             <p className="text-[1.5rem]" >As I develop Bite-Box, I'm implementing and documenting key React and JavaScript features, including:</p>
<ul className="list-none space-y-2 mt-2">
    ...
    <li className="flex items-center gap-2 text-[1.5rem]">
        ✅ CORS Policy: Understanding and handling cross-origin requests
             ...
             <div className="text-[1.5rem] p-[20px] rounded-[8px] bg-[#fff7e6] border-l-[5px] border-[#ffcc00]">Bite-Box is a work in progress, constantly evolving as I explore 
